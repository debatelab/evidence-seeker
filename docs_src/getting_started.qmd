...
+ [EvidenceSeeker Demoapp Logs](XX): This is a collection of fact-checks and their results performed by our Demoapp. You can use this to get an idea of the capabilities of the _EvidenceSeeker_ Demoapp.
...
```
<!--
TODO: What about JSON output? Would be better for further processing.
-->
