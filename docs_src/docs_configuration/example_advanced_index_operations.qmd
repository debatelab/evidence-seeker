...
You can find more details on the parameters above and other paramters used in the config file [here](./advanced_configuration.qmd#knowledge-base). For information on how to set up a PostgreSQL server, refer to the official documentation [here](https://www.postgresql.org/docs/).
